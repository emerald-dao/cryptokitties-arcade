<script lang="ts">
	import type { COURSES_COLORS } from '$courses/constants/colors';
...
<section class="border-b-2 border-solid border-border py-10 md:py-24">
	<div class="section grid grid-cols-4 gap-2 sm:gap-6 md:grid-rows-2 md:gap-10">
